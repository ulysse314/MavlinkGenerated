...
/*!
 Class that represents a SCALED_IMU2 Mavlink message.

 @discussion The RAW IMU readings for secondary 9DOF sensor setup. This message should contain the scaled values to the described units
 */
@interface MVMessageScaledImu2 : MVMessage
