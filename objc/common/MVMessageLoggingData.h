...
/*!
 Class that represents a LOGGING_DATA Mavlink message.

 @discussion A message containing logged data (see also MAV_CMD_LOGGING_START)
 */
@interface MVMessageLoggingData : MVMessage
